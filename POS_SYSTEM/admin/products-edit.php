                ...
                <div class="card-body">
                 ...
                 <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="mt-2">
                                <img src="..<?= $product['data']['image'] ?>" style="width: 80px; height: 80px; object-fit:cover;" alt="Img">
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="col-md-6">
                         ...
                         <br/>
                         <input type="checkbox" name="status" <?= $product['data']['status'] == 1 ? 'checked' : '' ?> value="1" style="width:30px;height:30px;">
                         </div>
